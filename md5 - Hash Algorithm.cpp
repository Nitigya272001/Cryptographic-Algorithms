...
class MD5 {
    public:
        ...
        void update(const uChar input[], uInt length) {
        ...
        void update(const char input[], uInt length) {
    ...
    private:
        ...
        void decode(uInt output[], const uChar input[], uInt length) {
        ...
        void encode(uChar output[], const uInt input[], uInt length) {
            for (uInt i = 0, j = 0; j < length; i++, j += 4) {
...
int main()
{
    ...
    cout<<"The message digest using MD5 Hash Algorithm is : "<<md5(msg)<<endl<<endl;

    cout<<"Enter the message 2 : ";
    cin>>msg;

    cout<<"The message digest using MD5 Hash Algorithm is : "<<md5(msg)<<endl;
}
